...
1. [Resistors](https://learn.sparkfun.com/tutorials/resistors)
1. [Diodes](https://learn.sparkfun.com/tutorials/diodes)
1. [Light-Emitting Diodes (LEDs)](https://learn.sparkfun.com/tutorials/light-emitting-diodes-leds)

##  Arduino UNO
1. [Overview of the Arduino UNO Components](https://docs.arduino.cc/tutorials/uno-rev3/intro-to-board)
